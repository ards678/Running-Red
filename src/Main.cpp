...
int main()
{
    ...
    Ground ground1("content/ground.png", Vector2f(0, 440 ), 1);
    Ground ground2("content/ground.png", Vector2f(1280, 440 ),2);
    Ground ground3("content/ground.png", Vector2f(2560, 440 ),3);
    Ground ground4("content/ground.png", Vector2f(3840, 440 ),4);
